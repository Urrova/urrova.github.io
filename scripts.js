	...
	switch (idioma){
		case "ingles":
			Marquee_Texts = new Array(
				...
				"PLEASE STOP WITH THE JOJO REFERENCE THING PLEASE, YEAH I ALREADY UNDERSTAND THAT MUDA MUDA ORA ORA LERO LERO GIORNOS THEME YO ANGELO AND THE VOCAL PERCUSSION ON A WHOLE NOTHER LEVEL COMING FROM YOUR MIND BUT PLEASE",
				"Sample Text",
				"Unf ~ Doomguy",
				"Yes ~ Quote",
		...
		case "español":
			Marquee_Texts = new Array(
				...
				"POR FAVOR PAREN DE HACER ESO DE LAS REFERENCIAS A JOJOS ME TIENEN HARTO POR FAVOR, SI YA ENTIENDO QUE MUDA MUDA ORA ORA LERO LERO EL TEMA DE GIORNO YO ANGELO Y LA PERCUSION VOCAL DE OTRO NIVEL SALIENDO DE TU MENTE PERO POR FAVOR",
				"Texto de Ejemplo",
				"Unf ~ Doomguy",
				"Yes ~ Quote",
				"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce imperdiet porttitor magna vitae rhoncus. Donec sed lectus mollis, aliquam erat et, dapibus lacus. Curabitur aliquam sem non posuere commodo. Fusce sodales, dolor ac volutpat vehicula, dolor enim blandit sem, a feugiat magna ex hendrerit nunc. Mauris nisi ligula, ultrices ac aliquet eget, imperdiet sed ipsum. Ut pharetra sodales ante nec.",
